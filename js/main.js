...
function init() {
	...
	for (i = 0; i < books.length; i++) {
        ...
        var bookNumberEle = $("<div class='book-number'>");
        bookNumberEle.text(i + 1);
        var bookTextEle = $("<div class='book-text'>");
        bookTextEle.text(books[i].name);
        ele.append(bookNumberEle);
