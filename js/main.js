...
function recalculateHints() {
    var weirdBookcaseIds = [525, 515, 511, 521, 526, 539, 536, 535, 533];
    ...
    if (length <= totalItems) {
        ...
        for (var i = 0; i < length + 2 * (totalItems - length) - 1; i++) {
